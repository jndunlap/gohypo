...
go test -v ./internal/analysis/brief/temporal/

# Run specific test
go test -v ./internal/analysis/brief/temporal/ -run TestFindCausalLead_PositiveLag

# Run integration test
go test -v ./internal/analysis/brief/temporal/ -run TestFullPipeline_SupportTicketsToUsageDrop
```
